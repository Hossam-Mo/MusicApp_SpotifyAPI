  ...
  return (
    <div className="secPage">

      {
        ...
        <SecTracks tracks={lists?.tracks} lists={lists?.lists}></SecTracks></div>: <div className='secPage_404Page'>    <svg viewBox="0 0 1134 340" className="secPage_logo">
            <title>Spotify</title>
            <path
              fill="white"
            ...
            ></path>
          </svg> <h1>Sorry we could not find this page</h1></div>
      }
